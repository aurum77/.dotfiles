...
" Set lightline theme
" Need nerd fonts for tux to appear
let g:lightline={'colorscheme': 'gruvbox',
      \ 'active': {
	      \   'right': [ [ 'syntastic', 'lineinfo', 'tux' ],
	      \              [ 'percent' ],
...
" Bind fd to escape to normal in terminal mode
tnoremap fd <C-\><C-n>
...
" Tabs are in spaces instead of characters
set expandtab

" vim-signify refresh rate setting
set updatetime=100
